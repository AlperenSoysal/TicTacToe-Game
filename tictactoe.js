...
function changeCellContent() {
  /*if(this.innerHTML === '') {
	...
	*/
  if (this.innerHTML === "") {
    if (Turnlabel1.innerHTML === "Player 1 Turn!") this.innerHTML = "X";
    // table[e.target.id] = "X"}
...
function checkMatch() {
  if (
    cellArr[0].innerHTML === cellArr[4].innerHTML &&
    cellArr[4].innerHTML === cellArr[8].innerHTML &&
    cellArr[0].innerHTML != ""
  ) {
    ...
    cellArr[0].innerHTML === cellArr[1].innerHTML &&
    cellArr[1].innerHTML === cellArr[2].innerHTML &&
    cellArr[0].innerHTML != ""
  ) {
    if (cellArr[0].innerHTML === "X") {
      gameState.score1++;
    ...
    cellArr[3].innerHTML === cellArr[4].innerHTML &&
    cellArr[4].innerHTML === cellArr[5].innerHTML &&
    cellArr[3].innerHTML != ""
  ) {
    ...
    cellArr[6].innerHTML === cellArr[7].innerHTML &&
    cellArr[7].innerHTML === cellArr[8].innerHTML &&
    cellArr[6].innerHTML != ""
  ) {
    ...
    cellArr[2].innerHTML === cellArr[4].innerHTML &&
    cellArr[4].innerHTML === cellArr[6].innerHTML &&
    cellArr[2].innerHTML != ""
  ) {
    ...
    cellArr[0].innerHTML === cellArr[3].innerHTML &&
    cellArr[3].innerHTML === cellArr[6].innerHTML &&
    cellArr[0].innerHTML != ""
  ) {
    if (cellArr[0].innerHTML === "X") {
      gameState.score1++;
    ...
    cellArr[1].innerHTML === cellArr[4].innerHTML &&
    cellArr[4].innerHTML === cellArr[7].innerHTML &&
    cellArr[1].innerHTML != ""
  ) {
    ...
    cellArr[2].innerHTML === cellArr[5].innerHTML &&
    cellArr[5].innerHTML === cellArr[8].innerHTML &&
    cellArr[2].innerHTML != ""
  ) {
    if (cellArr[2].innerHTML === "X") {
      gameState.score1++;
